<header>
  <div class="topIcon">
    <a href="gererSonDomicile?piece=VueGenerale" style= "text-decoration: none;">
      <img style= "margin-top: 0px;"draggable="false" src="image/logo.png" alt="DomoLink" width=200vw/>
    </a>
  ...
  <div class="topMenu">
    <div class="menuItem">
      <a href="a"><img draggable="false" src="image/aide.png" alt="DomoLink" width = 60vw/></a>
      <a href="default.asp"  class="caption">Aide</a>
    </div>
    <div class="menuItem">
      <a href="a"><img href="default.asp" draggable="false" href="" src="image/compte.png" alt="DomoLink" width = 60vw/></a>
    ...
    <div class="menuItem">
      <a href="a"><img href="default.asp" draggable="false" href="" src="image/accueil.png" alt="DomoLink" width = 60vw/></a>
